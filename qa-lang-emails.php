...
#     	ajouts pour la 1.7 par Pierre-Yves Aillet (pierreyves.aillet@free.fr)
	...
	return array(
		...
		'a_followed_body' => "Votre réponse sur ^site_title a une nouvelle idée liée par ^q_handle:\n\n^open^q_title^close\n\nVotre réponse était:\n\n^open^a_content^close\n\nCliquer ci-dessous pour répondre à la nouvelle idée:\n\n^url\n\nMerci,\n\n^site_title",
		'a_followed_subject' => 'Votre réponse sur ^site_title a une nouvelle idée liée',
		...
		'q_answered_body' => "Votre idée sur ^site_title a eu une réponse par ^a_handle:\n\n^open^a_content^close\n\nVotre idée était:\n\n^open^q_title^close\n\nSi cette réponse vous convient, vous pouvez la choisir comme la meilleure:\n\n^url\n\nMerci,\n\n^site_title",
		'q_answered_subject' => 'Votre idée sur ^site_title a une réponse',

		'q_commented_body' => "Votre idée sur ^site_title a un nouveau commentaire par ^c_handle:\n\n^open^c_content^close\n\nVotre idée était:\n\n^open^c_context^close\n\nVous pouvez répondre en ajoutant votre propre commentaire:\n\n^url\n\nMerci,\n\n^site_title",
		'q_commented_subject' => 'Votre idée sur ^site_title a un nouveau commentaire',

		'q_posted_body' => "Une nouvelle idée a été posée par ^q_handle:\n\n^open^q_title\n\n^q_content^close\n\nCliquez ci-dessous pour voir la idée:\n\n^url\n\nMerci,\n\n^site_title",
		'q_posted_subject' => '^site_title a une nouvelle idée',
