...
#     	ajouts pour la 1.7 par Pierre-Yves Aillet (pierreyves.aillet@free.fr)
	...
	return array(
		...
		'allow_close_questions' => 'Autoriser la fermeture manuelles des idées',
		'allow_login_email_only' => 'Seulement identifier par email (pas de pseudo)', 
		'allow_multi_answers' => 'Autoriser les réponses multiples par utilisateur',
		'allow_no_category' => 'Autoriser les idées sans catégorie',
		'allow_no_sub_category' => 'Autoriser les idées avec une catégorie mais pas de sous-catégorie',
		...
		'allow_self_answer' => 'Autoriser les utilisateurs à répondre à leur propre idée',
		'allow_view_q_bots' => 'Autoriser les moteurs de recherche à afficher les pages de idéè',
		...
		'avatar_q_list_size' => 'Taille d\'Avatar sur les listes des idées',
		'avatar_q_page_a_size' => 'Taille d\'avatar sur les réponses',
		'avatar_q_page_c_size' => 'Taille d\'avatar sur les commentaires',
		'avatar_q_page_q_size' => 'Taille d\'avatar sur les idées',
		'avatar_store_size' => 'Taille maximale de stockage avatars',
		'avatar_users_size' => 'Taille de l\'avatar en haut la page de l\'utilisateur',
		'block_bad_words' => 'Mots censurés - séparé par des espaces ou des virgules',
		...
		'captcha_on_unconfirmed' => 'Utiliser captcha si l\'email n\'est pas confirmé',
		...
		'comment_on_qs' => 'Autoriser les commentaires sur les idées suivantes',
		'confirm_user_emails' => 'Demande confirmation des emails des l\'utilisateurs',
		'confirm_user_required' => 'Tous les nouveaux utilisateurs doivent confirmer leur email',
		...
		'default_sidebar' => "Bienvenue sur ^, où vous pouvez proposer des idées et recevoir des réponses d'autres membres de la communauté.",
		'default_subject' => 'Un message de ^',
		'default_suffix' => 'Q&R',
		'default_terms' => 'J\'accepte les ^ Termes & Conditions et la politique de confidentialité',
		'do_ask_check_qs' => 'Vérifier les idées similaires quand vous proposez une idée',
		'do_close_on_select' => 'Fermer les idées avec une réponse séléctionnée',
		'do_complete_tags' => 'Afficher les mots clés correspondant en tapant',
		'do_count_q_views' => 'Compter le nombre de visites sur l\'idée',
		'do_example_tags' => 'Afficher des exemples de mots clés basés sur l\'idée',
		'editor_for_as' => 'Editeur par défaut pour les réponses',
		'editor_for_cs' => 'Editeur par défaut pour les commentaires',
		'editor_for_qs' => 'Editeur par défaut pour les idées',
		'email_privacy' => 'Note de confidentialité pour les adresses email - HTML autorisés',
		'extra_field_active' => 'Champ personnalisé pour demander des renseignements supplémentaires sur le formulaire',
		'extra_field_display_label' => 'Afficher les informations supplémentaires sur les pages de idées avec l\'étiquette',
		'extra_field_display' => 'Afficher les informations supplémentaires sur les pages des idéès',
		'feed_for_activity' => 'Flux pour activité récente',
		'feed_for_hot' => 'Flux pour les idéès A Voir!',
		'feed_for_qa' => 'Flux des idéès et réponses récentes',
		'feed_for_questions' => 'Flux pour les idées récentes',
		'feed_for_search' => 'Flux pour les résultats de recherche',
		'feed_for_tag_qs' => 'Flux pour pour chaque mots clés des idées',
		'feed_for_unanswered' => 'Flux pour les idées sans réponse',
		...
		'feedback_email' => 'Adresse email pour les messages admin - ne pas montré aux utilisateurs',
		...
		'flagging_notify_every' => 'Envoyez-moi encore un email après chaque messages supplémentaire',
		'flagging_notify_first' => 'Envoyez-moi un email si un message est reçu',
		'flagging_of_posts' => 'Autoriser les messages à être signalés',
		'follow_on_as' => 'Autoriser la création d\'idées liées à une réponse',
		'from_email' => 'Adresse de l\'expéditeur des messages à partir du site',
		'hot_weight_a_age' => 'Idée ayant une nouvelle réponse',
		'hot_weight_answers' => 'Idée ayant beaucoup de réponses',
		'hot_weight_q_age' => 'Idée nouvelle',
		'hot_weight_views' => 'Idée ayant de nombreuses visites',
		'hot_weight_votes' => 'Idée ayant de nombreux votes',
		...
		'mailing_from_email' => 'De l\'adresse email',
		...
		'match_4' => 'Large',
		'match_5' => 'Plus large',
		'match_ask_check_qs' => 'Suggérer des idées similaires',
		'match_example_tags' => 'Suggérer des exemple de mots clés',
		'match_related_qs' => 'Suggérer des idées liées',
		'max_len_q_title' => 'Longueur maximale du titre de la idée',
		...
		'max_rate_ip_qs' => 'Limite de idée postée',
		...
		'max_rate_user_qs' => 'Maximum d\'idées par utilisateur par heure',
		...
		'min_len_q_content' => 'Longueur minimum du corps de l\'idée',
		'min_len_q_title' => 'Longueur minimum du titre de l\'idée',
		...
		'moderate_notify_admin' => 'Email-moi lorsque le message doit être modéré',
		...
		'moderate_unconfirmed' => 'Utiliser la modération si l\'email n\'est pas confirmé',
		...
		'notify_admin_q_post' => 'Email cette adresse quand une idée est posté',
		...
		'page_size_qs' => 'Longueur de la page des idées',
		'page_size_related_qs' => 'Nombre maximum d\'idées liées',
		'page_size_search' => 'Nombre de résultat de recherche par page',
		'page_size_tag_qs' => 'Nombre d\'idées sur une page de mot clé',
		...
		'page_size_wall' => 'Nombre de message d\'un mur par page',
		...
		'permit_confirmed' => 'Les utilisateurs enregistrés avec email confirmé',
		...
		'permit_editors' => 'Editeurs, Modérateurs, Admins',
		'permit_experts' => 'Experts , Rédacteurs, Modérateurs, Admins',
		'permit_moderators' => 'Modérateurs et Administrateurs',
		'permit_points_confirmed' => 'Enregistrés & email confirmé & suffisamment de points',
		'permit_points' => 'Utilisateurs enregistrés avec suffisamment de points',
		'permit_see_emails' => 'Afficher les adresses email des utilisateurs',
		...
		'points_per_q_voted_down' => 'Quelqu\'un vote contre mon idée',
		'points_per_q_voted_up' => 'Quelqu\'un vote pour mon idée',
		'points_post_a' => 'Je propose une réponse',
		'points_post_q' => 'Je propose une idée',
		'points_q_voted_max_gain' => 'Limite de votes \'pour\' sur chaque idée',
		'points_q_voted_max_loss' => 'Limite de votes \'contre\' sur chaque idée',
		'points_select_a' => 'Je sélectionne une réponse comme étant la meilleure',
		'points_vote_down_a' => 'Je vote contre une réponse',
		'points_vote_down_q' => 'Je vote contre une idée',
		'points_vote_up_a' => 'Je vote pour une réponse',
		'points_vote_up_q' => 'Je vote pour une idée',
		'q_urls_remove_accents' => 'Supprimer les accents des idées dans l\'URL',
		'q_urls_title_length' => 'Longueur du titre des idées dans les URL',
		'register_notify_admin' => 'Email moi quand un nouvel utilisateur s\'enregistre',
		'search_module' => 'Utiliser le module de recherche',
		'show_a_form_immediate' => 'Afficher le formulaire de réponse immédiate',
		'show_always' => 'Toujours',
		'show_c_reply_buttons' => 'Afficher le bouton de réponse sur les commentaires',
		'show_custom_answer' => 'Message personnalisé sur le formulaire de réponse - HTML autorisés',
		'show_custom_ask' => 'Message personnalisé sur formulaire des idées - HTML autorisés',
		'show_custom_comment' => 'Message personnalisé sur le formulaire de commentaire - HTML autorisés',
		...
		'show_custom_register' => 'Message personnalisé sur le formulaire d\'inscription - HTML autorisés',
		...
		'show_custom_welcome' => 'Message personnalisé dans un courriel envoyé aux nouveaux utilisateurs enregistrés',
		...
		'show_view_counts' => 'Afficher nombre de vue dans les listes des idées',
		'show_view_count_q_page' => 'Afficher nombre de vue dans les pages des idées',
		'show_when_created' => 'afficher l\'age des messages des utilisateurs',
		'site_language' => 'Langue du site',
		'site_maintenance' => 'Mettre le systéme en maintenance temporaire.',
		...
		'sort_time' => 'Date',
		'sort_votes' => 'Votes',
		'suspend_register_users' => 'Suspendre temporairement nouvelles inscriptions',
		'tag_separator_comma' => 'Utiliser la virgule comme unique séparateur de mot clé',
		'tags_or_categories' => 'Classification de l\'idée',
		...
		'voting_on_q_page_only' => 'Autoriser le vote uniquement sur la page de l\'idée',
		'voting_on_qs' => 'Autoriser le vote sur les idées',
	);
